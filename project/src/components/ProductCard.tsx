      ...
      <div className="product-card-scale">
        ...
        >
          ...
          {/* Info — title with a fixed 2-line block so every price row aligns,
              then the price/sale line. The price row is the direct flex
              sibling of the title and carries its own margin-top so the
              gap can never collapse or be scoped away. */}
